...
if "%1"=="set" (
    if "%2"=="" (
        ...
        reg add "HKCU\Software\Microsoft\Windows\CurrentVersion\Internet Settings" /v ProxyOverride /t REG_SZ /d "*.tmw-m410;*.lz-cdn7.com;*.lz-cdn10.com;*.51.la;*.cbportal.org;*.6vw.cc;*.chinamobile.com;*.*.liuliangjia.cn;*.baisiweiting.com;*.haokongbu.top;*.lzcdn2.com;*.xlzyd.com;*.haokongbu123.com;*.mandudu.com;mrdeepfakes.com;mrdeepfakes.com;cmic.tools.bigcloudsys.cn;<local>" /f
